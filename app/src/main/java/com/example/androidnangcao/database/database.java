package com.example.androidnangcao.database;
...
public class database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //inset data
        sqLiteDatabase.execSQL(Data_SQLite.INSERT_subject);
        sqLiteDatabase.execSQL(Data_SQLite.INSERT_STUDENT);
